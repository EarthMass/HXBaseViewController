#
#  Be sure to run `pod spec lint HXBaseViewController.podspec' to ensure this is a
...
最好是 继承 HXBaseViewController 配置样式，然后继承你自定义的类。
  ...
  s.source       = { :git => "https://github.com/EarthMass/HXBaseViewController.git", :tag => "#{s.version}" }
